namespace Broken_Days {
    export async function EndDay(): ƒS.SceneReturn {
        ...
        await ƒS.update(1);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T00);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T01);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T03);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T04);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T05);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T06);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T07);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T08);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T09);
        ...
        await ƒS.update(1);
        await ƒS.Speech.tell(characters.mainCharacter, text.mainCharacter.T10);
        //await ƒS.Location.show(locations.room.night);
        //await ƒS.update(4);
